...
function template_main()
{
	...
	{
 echo '<div class="sedy_pruh">';
	theme_linktree();
	 echo '</div>';

		echo '          
	<div class="tborder childboards clear" id="board_', $context['current_board'], '_childboards">
		<div class="cat_bar">
		...
		{
			echo '
				<tr id="board_', $board['id'], '" class="u_tr_bg">
					<td class="icon1 windowbg"', !empty($board['children']) ? ' rowspan="2"' : '', '>
	...
	{
		echo '
	<div class="pagesection"> ',theme_linktree(),'
		<div class="pagelink">', $txt['pages'], ': ', $context['page_index'], !empty($modSettings['topbottomEnable']) ? $context['menu_separator'] . '&nbsp;&nbsp;<a href="#bot"><strong>' . $txt['go_down'] . '</strong></a>' : '', '</div>
	...
	<div class="tborder topic_table" id="messageindex">
		...
		if (!empty($context['topics']))
		{
			echo '
					...
					<th scope="col" class="lefttext padd " ><a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=subject', $context['sort_by'] == 'subject' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['subject'], $context['sort_by'] == 'subject' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a> / <a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=starter', $context['sort_by'] == 'starter' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['started_by'], $context['sort_by'] == 'starter' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a></th>
					<th scope="col" width="10" class="padd nobold"><a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=replies', $context['sort_by'] == 'replies' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['replies'], $context['sort_by'] == 'replies' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a> </th><th width="10" class="padd nobold"><a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=views', $context['sort_by'] == 'views' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['views'], $context['sort_by'] == 'views' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a></th>';
			// Show a "select all" box for quick moderation?
			if (empty($context['can_quick_mod']))
				echo '
					<th scope="col" class="righttext padd last_th nobold" width="22%"><a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=last_post', $context['sort_by'] == 'last_post' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['last_post'], $context['sort_by'] == 'last_post' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a></th>';
			else
				echo '
					<th scope="col" class="lefttext nobold" width="22%"><a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=last_post', $context['sort_by'] == 'last_post' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['last_post'], $context['sort_by'] == 'last_post' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a></th>';

			// Show a "select all" box for quick moderation?
			if (!empty($context['can_quick_mod']) && $options['display_quick_mod'] == 1)
				echo '
					<td>dd</td><th scope="col" class="last_th nobold" width="24"><input type="checkbox" onclick="invertAll(this, this.form, \'topics[]\');" class="input_check" />33</th>';

			// If it's on in "image" mode, don't show anything but the column.
			elseif (!empty($context['can_quick_mod']))
				echo '
					<td>dd</td><th class="last_th" width="4%">&nbsp;44</th>';
		}
		// No topics.... just say, "sorry bub".
			...
			echo '
					...
					<td>dd</td><th scope="col" class="last_th" width="8%">&nbsp;55</th>';
		...
		foreach ($context['topics'] as $topic)
		{
			...
			echo '
				<tr class="u_tr_bg">   
					...
					<img src="', $settings['images_url'], '/u_topic/', $topic['class'], '.png" alt="" />
					</td>
					<td class="icon2 ', $color_class, '">
						
					</td>
					<td class="subject padd ', $alternate_class, '">
			...
			echo '
					...
					<td class="lastpostb padd ', $alternate_class, '">
	...
	if (!$context['no_topic_listing'])
		echo '
			<p class="floatleft smalltext box">', !empty($modSettings['enableParticipation']) && $context['user']['is_logged'] ? '
' : '', '
				<img src="' . $settings['images_url'] . '/u_topic/people.png" width="24" alt="" align="middle" /> ' . $txt['normal_topic'] . '<br />
				<img src="' . $settings['images_url'] . '/u_topic/transmit.png" width="24" alt="" align="middle" /> ' . sprintf($txt['hot_topics'], $modSettings['hotTopicPosts']) . '<br />
				<img src="' . $settings['images_url'] . '/u_topic/transmit_blue.png" width="24 alt="" align="middle" /> ' . sprintf($txt['very_hot_topics'], $modSettings['hotTopicVeryPosts']) . '
			</p>
			<p class="smalltext box">
				<img src="' . $settings['images_url'] . '/u_topic/lock.png" width="24" alt="" align="middle" /> ' . $txt['locked_topic'] . '<br />' . ($modSettings['enableStickyTopics'] == '1' ? '
				<img src="' . $settings['images_url'] . '/u_topic/magnet.png" width="24" alt="" align="middle" /> ' . $txt['sticky_topic'] . '<br />' : '') . ($modSettings['pollMode'] == '1' ? '
				<img src="' . $settings['images_url'] . '//u_topic/anketa.png" width="24" alt="" align="middle" /> ' . $txt['poll'] : '') . '
			</p>';

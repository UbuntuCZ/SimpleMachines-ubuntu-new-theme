	...
	if ($context['is_poll'])
	{
		echo '
			<div id="poll">
				<div class="cat_bar">
					<h3 class="catbg">
						<span class="ie6_header floatleft"> ', $txt['poll'], '</span>
					</h3>
				</div>
				<div class="windowbg">
			...
			<div id="forumposts">
				<div class="cat_bar">
					<h3 class="catbg">
						...
						<span id="author">', $txt['author'], '</span><span class="small">
	...
	while ($message = $context['get_message']())
	{
		...
		if (!$message['member']['is_guest'])
		{
			...
			if (!isset($context['disabled_fields']['posts']))
				echo '
								<li class="postcount">', $txt['member_postcount'], ':<span style="color: #000"> ', $message['member']['posts'], '</span></li>';
		...
		echo '
						...
						<div class="postarea">
							<div class="flow_hidden">
								<div class="keyinfo padd top_padd">
		...
		if ($message['can_approve'] || $context['can_reply'] || $message['can_modify'] || $message['can_remove'] || $context['can_split'] || $context['can_restore_msg'])
			echo '
								<ul class="reset smalltext quickbuttons floatright">';
